...
| Workflow / Actions (CI status, logs, rerun)                   | ⚠️ read only (runs, jobs, workflows, job logs); rerun / cancel / dispatch planned ([#8](https://github.com/nemolize/remote-mcp-github/issues/8)) | ✅                        | ✅                               |
| Releases & tags                                               | ❌                                                                                                                                               | ✅                        | ✅                               |
