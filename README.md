...
| Actions administration (secrets, variables, cache, workflow enable / disable) | ❌ ([#194](https://github.com/nemolize/remote-mcp-github/issues/194))                                                                                                                                                                                                                                                                                                                                 | ❌                        | ✅                                                             |
...
| Projects (v2)                                                                 | 🟡 items read + write (`list_projects`, `get_project`, `list_project_items`, `list_project_fields`, `add_project_item`, `remove_project_item`, `update_project_item_field`, `create_project_draft_item`); no project / field CRUD (create / delete / edit project, field-create / field-delete, item-archive, link / unlink, copy) ([#193](https://github.com/nemolize/remote-mcp-github/issues/193)) | ✅                        | ✅ (`gh project`)                                              |
