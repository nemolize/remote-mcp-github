...
| Projects (v2)                                                  | 🟡 read-only (`list_projects`, `get_project`, `list_project_items`, `list_project_fields`); writes ([#140](https://github.com/nemolize/remote-mcp-github/issues/140))                                          | ✅                        | ✅ (`gh project`)                                              |
