...
| Projects (v2)                                                  | ✅ read + write (`list_projects`, `get_project`, `list_project_items`, `list_project_fields`, `add_project_item`, `remove_project_item`, `update_project_item_field`, `create_project_draft_item`)             | ✅                        | ✅ (`gh project`)                                              |
