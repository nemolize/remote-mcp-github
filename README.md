...
| PR read detail / merge / update lifecycle                                     | 🟡 no draft → ready-for-review (GraphQL `markPullRequestReadyForReview`), no lock / unlock                                                                                                                                                                                                                                         | ✅                        | ✅                                                             |
...
| Actions administration (secrets, variables, cache, workflow enable / disable) | ❌                                                                                                                                                                                                                                                                                                                                 | ❌                        | ✅                                                             |
| Releases & tags                                                               | 🟡 read + write (`list_releases`, `get_release`, `list_tags`, create / update / delete release); no asset upload / download                                                                                                                                                                                                        | ✅                        | ✅                                                             |
| Repo admin (create / fork / delete)                                           | ✅ create / fork / delete (`create_repository`, `fork_repository`, `delete_repository`)                                                                                                                                                                                                                                            | ✅                        | ✅                                                             |
| Repository configuration edit (rename, archive, deploy keys, autolinks)       | ❌                                                                                                                                                                                                                                                                                                                                 | ✅                        | ✅                                                             |
| Label definitions (create / edit / delete / clone)                            | ❌                                                                                                                                                                                                                                                                                                                                 | ✅                        | ✅                                                             |
...
| Projects (v2)                                                                 | 🟡 items read + write (`list_projects`, `get_project`, `list_project_items`, `list_project_fields`, `add_project_item`, `remove_project_item`, `update_project_item_field`, `create_project_draft_item`); no project / field CRUD (create / delete / edit project, field-create / field-delete, item-archive, link / unlink, copy) | ✅                        | ✅ (`gh project`)                                              |
