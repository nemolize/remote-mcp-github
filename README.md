...
| PR read detail / merge / update lifecycle                     | 🟡 core detail / merge / update shipped; per-file diff / combined status / branch update not yet ([#157](https://github.com/nemolize/remote-mcp-github/issues/157))  | ✅                        | ✅                                                             |
...
| Discussions (list / categories / get / comments)              | ❌ ([#160](https://github.com/nemolize/remote-mcp-github/issues/160))                                                                                                | ✅                        | ✅ (`gh discussion`, preview)                                  |
