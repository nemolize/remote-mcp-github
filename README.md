...
| Releases & tags                                                               | 🟡 read + write (`list_releases`, `get_release`, `list_tags`, create / update / delete release); no asset upload / download                                                                                                                                                                                                        | 🟡 read only              | ✅                                                             |
...
| Label definitions (create / edit / delete / clone)                            | 🟡 read only (`list_labels`); no create / edit / delete / clone                                                                                                                                                                                                                                                                    | 🟡 read only              | ✅                                                             |
